<?php
  ...
  $_SESSION['id_listname_user'] = $id_listname_user;
?>
<!DOCTYPE html>
            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <div class="panel-body">
                   <?php
    $sql = "SELECT * from formlistnameuser WHERE id_listname_user = '".$_GET["id_listname_user"]."' ";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
  ?>
                <form method="post" action="edit_listname_usershow.php?id_listname_user=<?php echo $row['id_listname_user'] ?>" id="form2">
                ...
                <div class="form-row">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      <label>หมู่</label>
                      <input type="text" class="form-control" name="moo" id="moo" value="<?php echo $row['moo']; ?>">
                    </div>
