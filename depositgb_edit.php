<?php
  ...
  $_SESSION['id_deposit_gb'] = $id_deposit_gb;
?>
<!DOCTYPE html>
...
font-size: 16px;"><a href="login.html" class="btn btn-danger square-btn-adjust">ออกจากระบบ</a> </div>
            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <div class="panel-body">
                   <?php
    $sql = "SELECT * from deposit_gb WHERE id_deposit_gb = '".$_GET["id_deposit_gb"]."' ";
  ...
  ?>
                ...
                <div class="form-group">
                  ...
                  <label>คันที่:</label>
                   <select name="cargb" id="cargb" class="form-control" value="<?php echo $row['cargb']; ?>">;
                     <option value="<?php echo $row['cargb']; ?>"><?php echo $row['cargb']; ?></option>
                    ...
                    <div class="form-group col-md-4">
                      <label>ประเภทขยะ</label>
                       <select name="catergory_gb" id="catergory_gb" class="form-control" value="<?php echo $row['catergory_gb']; ?>">;
                         <option value="<?php echo $row['catergory_gb']; ?>"><?php echo $row['catergory_gb']; ?></option>
