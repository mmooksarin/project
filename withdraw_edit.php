<?php
  ...
  $_SESSION['id_withdraw'] = $id_withdraw;
     ...
     <li class="text-center">
       ...
       <li>
           ...
           <ul class="nav nav-second-level">
               ...
               <li>
                   <a href="deposit_gbshow.php">ข้อมูลการฝาก</a>
               </li>
           </ul>
            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <div class="panel-body">
                   <?php
    $sql = "SELECT * from withdraw WHERE id_withdraw = '".$_GET["id_withdraw"]."' ";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
  ?>
                <form method="post" action="edit_withdrawshow.php?id_withdraw=<?php echo $row['id_withdraw'] ?>"  id="form2">
                ...
                <div class="form-group col-md-12">
                  ...
                  <textarea class="form-control" name="note" id="note" rows="3" ><?php echo $row['note']; ?></textarea>
                         ...
                         <br>
                           ...
                           <a href="withdraw_show.php"class="btn btn-default">ยกเลิก</a>
                      </form>
