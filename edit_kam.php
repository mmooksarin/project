            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <div class="panel-body">
                   <?php
    $sql = "SELECT * from fn_kam WHERE id_kam = '".$_GET["id_kam"]."'";;
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
  ?>
                <form method="post" action="edit_fnkam_show.php?id_kam=<?php echo $row['id_kam'] ?>" id="form2">
                      ...
                      <div class="form-group col-md-6">
                       ...
                       <div class="form-row">
                         ...
                         <div class="form-row">
                           ...
                           <a href="listnamekammakan.php"class="btn btn-default">ยกเลิก</a>
                         </form>
                         <br>
