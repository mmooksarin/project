    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="indexadmin1.php">personnel</a>
            </div>
          ...
          <li  >
            ...
            <li  >
              <a class="active-menu"  href="garbageprice1.php"><i class="fa fa-table fa-3x"></i>ราคาขยะ</a>
          </li>
          <li  >
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                 ...
                 <form action="phpLlistmenuDatebase2.php" method="post" name="form1">
                  <button data-toggle="dropdown" class="btn btn-default dropdown-toggle">ประเภทขยะ<span class="caret"></span></button>
                      <?
                      $strSQL = "SELECT * FROM catergory ORDER BY name ASC";
                      $objQuery = mysql_query($strSQL);
                      while($objResuut = mysql_fetch_array($objQuery))
                         {
                      if($strDefault == $objResuut["id_price_garbage"])
                         {
                      $sel = "selected";
                      }
                      else
                  ...
                  ?>
    <option value="<?=$objResuut["1"];?>" <?=$sel;?>><?=$objResuut["2"]." - ".$objResuut["Name"];?></option>
       <?
        }
           ?>
                                 ...
                                 <div class="table-responsive">
                                     <table class="table table-striped table-bordered table-hover">
                                         ...
                                         while($row = $results->fetch_assoc()) {
                                             ?>
                                         <tr>
                                              <td><?php echo $row['type_garbage'] ?></td>
                                              <td><?php echo $row['price_unit'] ?></td>
                                               <td>
                                                  <a href="depositgb_edit.php?id_deposit_gb=<?php echo $row['id_deposit_gb'] ?>" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-pencil"></span>
                                                         แก้ไข
                                                     </a></td>
                                         </tr>
                                             <?php
