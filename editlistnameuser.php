...
font-size: 16px;"><a href="login.html" class="btn btn-danger square-btn-adjust">ออกจากระบบ</a> </div>
  ...
  ?>
                <form method="post" action="listnameuser_update.php" id="form2">

                       <div class="form-group col-md-6">
                         <label>เลขที่สมาชิก</label>
                         <input type="text" class="form-control" name="$account_number" id="number_user" value="<?php echo $row['$account_number']; ?>">
                       </div>
                       <div class="form-group col-md-6">
