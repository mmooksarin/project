...
<body>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
          ...
          <li>
            <a class="active-menu" href="namemember.php"><i class="fa fa-desktop fa-3x"></i>รายชื่อ</a>
          </li>
            <li>
                ...
                <div class="row">
                  ...
                  <div class="section group">
                    <div class="panel-body">
                      <div class="col-md-4">
                      <img src="assets/img/addname.png" class="user-image img-responsive">
                      <center>
                        <div class="btn-group">
  											  <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle">ฟอร์มกรอกรายชื่อ<span class="caret"></span></button>
  											  <ul class="dropdown-menu">
  												<li><a href="formlistnameuser.php">รายชื่อสมาชิก</a></li>
  												<li><a href="fn_kam.php">รายชื่อกรรมการ</a></li>
  												<li><a href="#">รายชื่อผู้เข้าร่วมประจำวันประจำวัน</a></li>
  											  </ul>
  											</div>
                        </center>
                      </div>
                      <div class="col-md-4">
                      <img src="assets/img/addname1.png" class="user-image img-responsive">
                      <center>
                        <div class="btn-group">
                         <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle">แสดงรายชื่อทั้งหมด<span class="caret"></span></button>
                         <ul class="dropdown-menu">
                         <li><a href="listnameuser.php">รายชื่อสมาชิก</a></li>
                         <li><a href="listnamekammakan.php">รายชื่อกรรมการ</a></li>
                         <li><a href="#">รายชื่อผู้เข้าร่วมประจำวันประจำวัน</a></li>
                         </ul>
                       </div>
                        </center>
