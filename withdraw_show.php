        ...
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
          ...
          <li>
              ...
              <ul class="nav nav-second-level">
                  ...
                  <li>
                      <a class="active-menu" href="withdraw_show.php">ข้อมูลการถอนเงิน</a>
                  </li>
              </ul>
                                         ...
                                         <thead>
                                           ...
                                           <tr>
                                                ...
                                                <td><?php echo $row['note'] ?></td>
                                                 <td>
                                                    <a href="withdraw_edit.php?id_withdraw=<?php echo $row['id_withdraw'] ?>" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-pencil"></span>
                                                           แก้ไข
                                                       </a></td>
                                                <td> <a onclick="return confirm('ต้องการลบข้อมูลนี้หรือไม่')" href="withdraw_delete.php?id_withdraw=<?php echo $row['id_withdraw'] ?>" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span>
                                                           ลบ
                                                       </a></td>
                                           </tr>
                                               <?php
