    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
          ...
          <li>
              ...
              <ul class="nav nav-second-level">
                  <li>
                      <a class="active-menu" href="deposit1.php">ขยะ</a>
                  </li>
                  <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                padding: 15px 50px 5px 50px;
                float: right;
                font-size: 16px;"><a href="deposit_gbshow.php" class="btn btn-primary">ข้อมูลการฝากเงิน</a> </div>
                    <div class="col-md-12">
                     <center>
                       <h2>ฝาก-ถอน</h2>
                ...
                <form method="post" action="deposit_insert.php">
                     <div class="form-row">
                   ...
                   <div class="form-group">
                     ...
                     <label>คันที่:</label>
                      <select name="cargb" id="cargb" class="form-control">;
                       ...
                       <div class="form-group col-md-4">
                         <label>ประเภทขยะ</label>
                          <select name="catergory_gb" id="catergory_gb" class="form-control">;
                       ...
                       <div class="form-group col-md-4">
                       <input class="btn btn-primary" type="button" id="add-row" value="เพิ่มแถว">
                       </div>
