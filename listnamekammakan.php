                                     ...
                                     <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                         <thead>
                                           ...
                                           <tr>
                                                 ...
                                                 <td>
                                                    <a href="edit_kam.php?id_kam=<?php echo $row['id_kam'] ?>" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-pencil"></span>
                                                           แก้ไข
                                                       </a></td>
                                                <td> <a onclick="return confirm('ต้องการลบข้อมูลนี้หรือไม่')" href="delete_kam.php?id_kam=<?php echo $row['id_kam'] ?>" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span>
                                                           ลบ
                                                       </a></td>
                                           </tr>
                                               <?php
