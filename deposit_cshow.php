                                         ...
                                         <thead>
                                           ...
                                           <tr>
                                                ...
                                                <td><?php echo $row['note'] ?></td>
                                                 <td>
                                                    <a href="deposit2_edit.php?id_deposit_cash=<?php echo $row['id_deposit_cash']; ?>" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-pencil"></span>
                                                           แก้ไข
                                                       </a></td>
                                                <td> <a onclick="return confirm('ต้องการลบข้อมูลนี้หรือไม่')" href="deposit2_delete.php?id_deposit_cash=<?php echo $row['id_deposit_cash']; ?>" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span>
                                                           ลบ
                                                       </a></td>
                                           </tr>
                                               <?php
