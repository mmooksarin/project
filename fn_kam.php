      ...
      <!-- /. NAV SIDE  -->
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                padding: 15px 50px 5px 50px;
                float: right;
                font-size: 16px;"><a href="listnamekammakan.php" class="btn btn-warning">รายชื่อทั้งหมด</a> </div>
                    <div class="col-md-12">
                     <center>
                       <h2>กรอกรายชื่อกรรมการ</h2>
                    </div>
                ...
                <form method="post" action="fn_kaminsert.php" id="form2">
