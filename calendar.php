...
<head>
  ...
  <!-- Favicons -->
  <link href="img_dashio/favicon.png" rel="icon">
  <link href="img_dashio/apple-touch-icon.png" rel="apple-touch-icon">

  <!-- Bootstrap core CSS -->
  <link href="lib_dashio/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <!--external css-->
        ...
        <ul class="nav top-menu">
          ...
          <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="index.html#">
                  <span class="photo"><img alt="avatar" src="img_dashio/ui-zac.jpg"></span>
                  <span class="subject">
              ...
              <li>
                <a href="index.html#">
                  <span class="photo"><img alt="avatar" src="img_dashio/ui-divya.jpg"></span>
                  <span class="subject">
              ...
              <li>
                <a href="index.html#">
                  <span class="photo"><img alt="avatar" src="img_dashio/ui-danro.jpg"></span>
                  <span class="subject">
              ...
              <li>
                <a href="index.html#">
                  <span class="photo"><img alt="avatar" src="img_dashio/ui-sherman.jpg"></span>
                  <span class="subject">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="img_dashio/ui-sam.jpg" class="img-circle" width="80"></a></p>
